...
@prismify/ko/0.0.24 darwin-x64 node-v14.0.0
$ ko --help [COMMAND]
USAGE
  $ ko COMMAND
...
...
_See code: [src/packages/cli/clone.ts](https://github.com/prismify-co/ko/blob/v0.0.24/src/packages/cli/clone.ts)_
...
_See code: [src/packages/cli/create.ts](https://github.com/prismify-co/ko/blob/v0.0.24/src/packages/cli/create.ts)_
...
_See code: [src/packages/cli/install.ts](https://github.com/prismify-co/ko/blob/v0.0.24/src/packages/cli/install.ts)_
<!-- commandsstop -->
