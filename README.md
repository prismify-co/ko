...
@prismify/ko/0.0.10 darwin-x64 node-v14.0.0
$ ko --help [COMMAND]
USAGE
  $ ko COMMAND
...
...
_See code: [src/commands/clone.ts](https://github.com/prismify-co/ko/blob/v0.0.10/src/commands/clone.ts)_
...
_See code: [src/commands/create.ts](https://github.com/prismify-co/ko/blob/v0.0.10/src/commands/create.ts)_
...
_See code: [src/commands/install.ts](https://github.com/prismify-co/ko/blob/v0.0.10/src/commands/install.ts)_
<!-- commandsstop -->
